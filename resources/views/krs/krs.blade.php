...
<div
    ...
    <div
        ...
        <div class="w-full md:w-auto">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Daftar KRS Mahasiswa</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Total: {{ $daftarKrs->count() }} Mata Kuliah, {{ $daftarKrs->sum('totalSKS') }} SKS
            </p>
        </div>
            ...
            <tbody>
                @forelse($daftarKrs as $krs)
                    ...
                    <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-4 py-3">{{ $mk->dosen ?? '-' }}</td>
                    </tr>
                    @endforeach
                @empty
